    ...
    <div className="relative min-h-screen bg-transparent flex flex-col items-center justify-center p-6 sm:p-10">
      ...
      <div className="relative z-10 w-full max-w-[400px] flex flex-col gap-8">
        <div className="flex flex-col items-center gap-2 text-center">
          ...
          <h1 className="text-3xl font-black tracking-tighter text-neutral-900 dark:text-neutral-100">
            SplitSmart
          </h1>
          <p className="text-sm text-muted-foreground font-medium uppercase tracking-widest tracking-tight">
            Join the new era of clarity
          </p>
        </div>
        ...
        <Card className="border-border/60 shadow-2xl bg-card/55 backdrop-blur-3xl">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardDescription>
              Enter your details and get started in seconds
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <Button
                type="submit"
                variant="neon"
                className="w-full h-12 font-bold tracking-tight mt-6 rounded-xl shadow-lg hover:translate-y-[-1px] transition-all"
              >
                Create Account
              </Button>
            </form>
