...
export function CinematicHero({
  brandName = "SplitSmart",
  tagline1 = "Split expenses, Not friend's !!.",
  tagline2 = "",
  cardHeading = "Financial intelligence, simplified.",
  cardDescription = (
    <>
      <span className="text-white font-semibold">SplitSmart</span> uses a greedy
      algorithm to minimize transactions and settle debts efficiently across
      your social groups.
    </>
  ),
  metricValue = 50000,
  metricLabel = "Expenses Split",
  ctaHeading = "Ready to split?",
  ctaDescription = "Join thousands of users who have streamlined their group finances with SplitSmart.",
  className,
  ...props
}) {
  ...
  const hasSecondaryTagline = Boolean(tagline2?.trim());
  ...
  useEffect(() => {
    ...
    return () => ctx.revert();
  }, [metricValue, hasSecondaryTagline]);

  return (
    <div
      ref={containerRef}
      className={cn(
        "relative w-screen h-screen overflow-hidden flex items-center justify-center bg-transparent text-foreground font-sans antialiased",
        className,
      )}
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <Button
            ...
            size="lg"
            asChild
            className="rounded-[1.25rem] px-10 py-8"
          >
            <Link to="/login">
          ...
          >
            <Link to="/register">
              <div className="text-left">
                <div className="text-[10px] font-bold tracking-wider text-neutral-400 dark:text-neutral-900 uppercase mb-[-2px]">
                  Join us
                </div>
                <div className="text-xl font-bold leading-none tracking-tight">
                  Get Started
